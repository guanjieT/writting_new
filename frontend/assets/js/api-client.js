...
export const api = {
  ...
  runRoughVolumeOutline: (projectId, payload) => requestJson(`/projects/${encodeURIComponent(projectId)}/rough-volume-outline`, { method: 'POST', body: payload }),
  ...
  runRoughChapterPlan: (projectId, payload) => requestJson(`/projects/${encodeURIComponent(projectId)}/rough-chapter-plan`, { method: 'POST', body: payload }),
